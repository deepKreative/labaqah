...
// import { $ } from '../typings/jquery/jquery';
...
export class CheckoutPage implements OnInit {
    ...
    constructor(
        ...
        public route: ActivatedRoute/*, private braintree: Braintree*/) {
            ...
            this.api.getDeliveryOptions().subscribe((res)=>{
                ...
                if(this.divDist < 15){
                    this.delPrice = this.optionslList['1-to-15-km-2'];
                }else if(this.divDist > 15 && this.divDist < 25)
                {
                    this.delPrice = this.optionslList['15-onward-2'];
                }else{
                    this.delPrice = "sorry in your place you can just use local pickup";
                }
    ...
    async updateOrder() {
        ...
        await this.api.updateOrderReview('update_order_review', this.checkoutData.form).subscribe(res => {
            ...
            console.log('this.orderReview',this.orderReview);
    ...
    async updateOrderReview() {
        ...
        this.orderReview.shipping.forEach((item, index) => {
            this.showOption = item.chosen_method;
            this.checkoutData.form['shipping_method[' + index + ']'] = item.chosen_method;
            console.log('this.checkoutDat',item);
        });
        this.checkoutData.form.security = this.checkoutData.form.nonce.update_order_review_nonce;
        this.checkoutData.form['woocommerce-process-checkout-nonce'] = this.checkoutData.form._wpnonce;
        this.checkoutData.form['wc-ajax'] = 'update_order_review';
    ...
    async placeOrder() {
        ...
        console.log('response.0',this.checkoutData.form.payment_method);
        ...
        if (this.checkoutData.form.payment_method == 'alg_custom_gateway_1'){
            
            ...
            //     "processData": false,
            //     "data": {"client_reference_id": "123123","products": [{"name": "Mobile Phone","unit_amount": 2000,"quantity": 3},{"name": "Kage","unit_amount": 1500,"quantity": 1}],"success_url": "https://google.com","cancel_url": "https://youtube.com","metadata": {"customer": "Thawani User","order_id": 10}}
            // };

            // this.http.post('https://uatcheckout.thawani.om/api/v1/checkout/session',data,).subscribe(
            //     data => console.log('success', data),
            //     error => console.log('oops', error)
            // );

            const headers = { 'Content-Type': 'application/json','Secret_key':'rRQ26GcsZzoEhbrP2HZvLYDbn9C9et' };
            const data ={"client_reference_id": "123123","products": [{"name": "Mobile Phone","unit_amount": 2000,"quantity": 3},{"name": "Kage","unit_amount": 1500,"quantity": 1}],"success_url": "https://google.com","cancel_url": "https://youtube.com","metadata": {"customer": "Thawani User","order_id": 10}};
        
            this.http.post<any>('https://uatcheckout.thawani.om/api/v1/checkout/session', data, { headers }).subscribe(
                data => console.log('success', data),
                error => console.log('oops', error)
           );
            ...
            //     //  }else{
            //     //     console.log('response4.1',response);
            //     //  };
        ...
        if (this.checkoutData.form.payment_method == 'stripe'){
            ...
            console.log('response1',this.checkoutData.form);
    ...
    handleOrder() {
        if (this.results.result == 'success') {
            console.log('response4',this.results.result);
    ...
    async onClickStripeSubmit() {
        ...
        if (!this.checkoutData.form.shipping) {
                this.checkoutData.form.shipping_first_name = this.checkoutData.form.billing_first_name;
                //this.checkoutData.form.delivery_date = this.checkoutData.form.billing_first_name;
                this.checkoutData.form.shipping_last_name = this.checkoutData.form.billing_last_name;
                this.checkoutData.form.shipping_company = this.checkoutData.form.billing_company;
                this.checkoutData.form.shipping_address_1 = this.checkoutData.form.billing_address_1;
                this.checkoutData.form.shipping_address_2 = this.checkoutData.form.billing_address_2;
