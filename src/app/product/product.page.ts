...
export class ProductPage {
    ...
    //             if (result) {
    //                  //alert('please clear '+result);
    //                 var isclear= this.warn(result);
    //                 if(await isclear == true){
    //                     this.getandclearCart(product)
    //                     }else{ }     
    //             }
    //             else{
    //                 this.validatedtocart(product,product.vendor.name);
    //             }
    //           });
    //     }
    // }
    ...
    async getCart(product) {
        await this.api.postItem('cart').then(res => {
           ...
           if(this.cart.cart_contents.vendor.name==product.vendor.name)
           {
            //    alert('matched');
           }
           else{
            ...
            {
                // alert('cart'+JSON.stringify(this.cart[i]) );
                // alert('cart' );

                if(this.cart[i].vendor.name==product.vendor.name)
                {
                    // alert('matched');
                }
                else{
